    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            ...
            <div class="text-center mb-4">
                <img src="img/IMG_20180614_163340_1.jpg.webp" alt="Vaszilij" class="img-fluid rounded">
            </div>

            <h1 class="text-center">Naplónak indult.</h1>
            <h2 class="text-center">Bemutató bloggá vált.</h2>
            ...
            <div class="ratio ratio-16x9 mt-4 mb-5">
                <iframe src="https://www.youtube.com/shorts/xdTMeuoXFDU" 
